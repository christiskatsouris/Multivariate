...
$$ X_t = (  X_{1t},..., X_{pt} ) \ \ \ \text{with} \ \ \ t=1,...,n$$ 
...
# Multivariate Conditional Heteroscedastic based models include the following: 
# 1. DCC Model 
# 2. CCC Model
# 3. BEKK Model 
# 4. Copula-GARCH Model 
...
# Define a DCCspec object: 2 stage estimation 
